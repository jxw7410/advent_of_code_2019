...
def find_manhatten_distance(wire1, wire2)
  ...
  ranges_2.each do |range2|
    ranges_1.each do |range1|
      intersection = get_intersections(range1, range2)
...
def get_intersections(range1, range2)
